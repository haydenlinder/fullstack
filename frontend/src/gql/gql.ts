...
const documents = {
    ...
    "\nmutation CreatePost($body: String = \"\", $creator_id: String = \"\", $title: String = \"\", $data: [post_tags_insert_input!] = {post_id: \"\", tag_id: \"\"}) {\n  insert_posts(objects: {body: $body, creator_id: $creator_id, title: $title, post_tags: {data: $data}}) {\n    returning {\n      id\n    }\n  }\n}\n": types.CreatePostDocument,
